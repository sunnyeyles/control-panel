...
- Whether the foundation must include a persistence primitive (storage account, table, blob) for briefing output — hangs on how the proof task's success is defined.
